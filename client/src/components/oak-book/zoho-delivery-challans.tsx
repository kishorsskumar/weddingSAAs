...
export function ZohoDeliveryChallans() {
  ...
  return (
    <div className="flex h-full">
      <div className={cn("flex-1 flex flex-col transition-all duration-300", selectedChallan ? "mr-[480px]" : "")}>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="h-8">
                  ...
                  {statusFilter === "all" ? "All Status" : CHALLAN_STATUSES.find((s) => s.value === statusFilter)?.label}
          ...
          <table className="w-full">
            <thead className="bg-gray-100 sticky top-0">
              <tr className="text-left text-sm text-gray-600">
                ...
                <th className="p-3 font-medium">DELIVER TO</th>
                <th className="p-3 font-medium hidden md:table-cell">VEHICLE</th>
              ...
              {filteredChallans.length === 0 ? (
                ...
                filteredChallans.map((challan) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-sm text-gray-700 max-w-[200px] truncate">
                      {challan.deliverTo || "—"}
                    </td>
