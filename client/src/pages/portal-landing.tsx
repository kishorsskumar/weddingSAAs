        ...
        <header className="bg-white border-b sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/oakstreet-logo.jpg" alt="Oakstreet Events" className="h-10 w-auto" />
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  By submitting this form, you agree to receive communications from Oakstreet Events via WhatsApp and email.
                </p>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-white">
      <header className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://instagram.com/oakstreetevents" target="_blank" rel="noopener" className="text-gray-500 hover:text-pink-600">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="https://facebook.com/oakstreetevents" target="_blank" rel="noopener" className="text-gray-500 hover:text-blue-600">
              <Facebook className="w-5 h-5" />
            </a>
            <a href="https://youtube.com/@oakstreetevents" target="_blank" rel="noopener" className="text-gray-500 hover:text-red-600">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Welcome to <span className="text-[#4b7c29]">Oakstreet Events</span>
            </h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-green-100 mb-12">
            <p className="text-lg text-gray-700 leading-relaxed text-center mb-8">
              At Oakstreet, we specialize in <strong className="text-[#4b7c29]">luxury weddings, destination celebrations, and bespoke event experiences</strong> that truly reflect your vision and personality. 💍🌿
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
              ...
              <a 
                href="https://client.oakstreetevents.in/oak-portfolio" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.youtube.com/@oakstreetevents4u" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.oakstreetevents.com" 
                target="_blank" 
                rel="noopener noreferrer"
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 italic">
              Warm regards,<br />
              <strong className="text-[#4b7c29]">Team Oakstreet Events</strong><br />
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-4">Why Choose Oakstreet?</h3>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-4">Oakstreet Events</h4>
              <p className="text-gray-400 text-sm">
                Crafting memorable celebrations across Kerala since 2014. From intimate gatherings to grand weddings, we bring your dreams to life.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-2 text-gray-400 text-sm">
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4" /> +91 79023 73354
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4" /> info@oakstreetevents.com
                </div>
                <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://instagram.com/oakstreetevents" target="_blank" rel="noopener" className="text-gray-400 hover:text-white">
                  <Instagram className="w-6 h-6" />
                </a>
                <a href="https://facebook.com/oakstreetevents" target="_blank" rel="noopener" className="text-gray-400 hover:text-white">
                  <Facebook className="w-6 h-6" />
                </a>
                <a href="https://youtube.com/@oakstreetevents" target="_blank" rel="noopener" className="text-gray-400 hover:text-white">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
            © {new Date().getFullYear()} Oakstreet Events. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
